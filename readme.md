...
* The SMTP notification worker works in docker system, in live website link the Email notifications are routed to a verified sandbox inbox for demo purposes due to Domain Issues(Email sending to arbitrary users requires DNS ownership).
